...
export const DANIEL: Daniel = {
  ...
  links: [
    ...
    {link:'https://twitter.com/good_eipi', image:'twitter-24x24.png', label: "Daniel Christo's Twitter Link", altText: "Twitter"},
    ...
    {link:'https://www.facebook.com/daniel.christo.5', image:'facebook-24x24.png', label: "Daniel Christo's Facebook Link", altText: "Facebook"},
  ],
